...
function(oj, ko, $, configService)
{
  ...
  function viewModel()
  {
    ...
    self.totalBookBalance = ko.observable('32,999,713.11');
    self.totalMortgageIns = ko.observable('154,407.00');
    self.totalInitPurchValue = ko.observable('32,999,713.11');
    self.totalDeferredPurchValue = ko.observable('29,560.93');
    self.totalCagamasInstallment = ko.observable('433,660.07');
    self.totalReviewDateValue = ko.observable('31,860,186.68');
    self.intDebitPractice = ko.observable('0');
    self.intDebitPeriod = ko.observable('0');
