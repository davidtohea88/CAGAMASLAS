        ...
        'ojs/ojdatetimepicker', 'ojs/ojswitch', 'ojs/ojslider','ojs/ojcollapsible'],
          function(oj, ko, $)
          {
            ...
            function mgpViewModel() {
                var self = this;
                self.header = "MGP MASD Part1 Fully Disbursed Report";
...
var mgpViewModel = new mgpViewModel();
   ...
   $("#textStatus").text ="Submitted for Approval";
        this.reportStatus ="Submitted for Approval";
