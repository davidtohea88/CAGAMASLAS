...
define(['ojs/ojcore', 'knockout', 'data/data', 'jquery', 'ojs/ojrouter', 'ojs/ojknockout', 'promise', 'ojs/ojlistview', 'ojs/ojmodel', 'ojs/ojtable', 'ojs/ojbutton', 'ojs/ojarraytabledatasource', 'ojs/ojpagingcontrol', 'ojs/ojpagingtabledatasource'],
        function (oj, ko, data, $)
        {
            function rateTypeViewModel() {
                ...
                self.allPeople = ko.observableArray([{rateTypCd: "Fetching data"}]);
                self.tempPeople = ko.observableArray([{rateTypCd: "Fetching data"}]);
                self.rateTypDataSource = new oj.PagingTableDataSource(new oj.ArrayTableDataSource(self.allPeople, {idAttribute: 'rateTypCd'}));
...
//                                headers: {"Authorization": "Basic " + btoa("username:password")},
                                ...
                                {
                                    self.allPeople(data.MdRateTyp);
                                    self.tempPeople(data.MdRateTyp);
