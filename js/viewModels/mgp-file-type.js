...
define(['ojs/ojcore', 'knockout', 'services/rendererService', 'services/configService', 
    ...
    'ojs/ojpagingtabledatasource', 'ojs/ojknockout-validation', 'moment','ojs/ojselectcombobox','ojs/ojcheckboxset'],
        function (oj, ko, rendererService, configService, exportService, customURL, $)
        {
            function productgroupMainViewModel() {
                ...
                self.header =  ko.observable("Mortgage Guarantee Program - Template/File Type");
                ...
                self.isTemplate = ko.observable('N');
        ...
        self.selectProd  = ko.observable('');    
         ...
         self.lovTemplate =  ko.observableArray([
    
            { value: "template", label: "template" },
            { value: "template2", label: "template2" },
            { value: "template3", label: "template3" } ]);
        self.selectTemplate = ko.observable('');   
