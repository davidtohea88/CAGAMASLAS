...
define(['ojs/ojcore', 'knockout','jquery', 'services/rendererService', 'services/RestService','services/exportService', 'services/MessageService', 'ojs/ojrouter',
        ...
        {
            function counterpartyRatingMainViewModel() {
                var self = this;
                var restService = RestService.counterpartyRatingService();
                self.header = "Counterparty Rating";
            ...
            return counterpartyRatingMainViewModel();
        }
); 