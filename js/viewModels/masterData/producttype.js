        ...
        function (oj, ko, $, rendererService, RestService, exportService, MessageService)
        {
            function prodTypeViewModel() {
                ...
                self.save = function (model,successMsg) {
                    ...
                    model.save(defaultAttributes,{
                        success: function(model){
                            self.refreshData();
                            var message = successMsg? successMsg: (model.isNew()?'A new Product type is successfully created':'Product type is successfully updated');
                ...
                self.activateDeactivate = function (model) {
                    ...
                    self.save(model,"Product type \""+model.attributes.prodTypeName+"\" is successfully "+(model.attributes.active==='Y'?'activated':'deactivated'));
                };
