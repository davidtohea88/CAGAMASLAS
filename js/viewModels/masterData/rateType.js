        ...
        function (oj, ko, $, rendererService, RestService, exportService, MessageService)
        {
            function rateTypeViewModel() {
                ...
                self.save = function (model,successMsg) {
                    ...
                    model.save(defaultAttributes,{
                        success: function(model){
                            self.refreshData();
                            var message = successMsg? successMsg: (model.isNew()?'A new Rate type is successfully created':'Rate type is successfully updated');
                ...
                self.activateDeactivate = function (model) {
                    ...
                    self.save(model,"Rate type \""+model.attributes.prchsModeName+"\" is successfully "+(model.attributes.active==='Y'?'activated':'deactivated'));
                };
