    ...
    'ojs/ojjsontreedatasource'
        ...
        function (oj, ko, $, utils) {
            ...
            router.configure({
                ...
                'mgp-msad-upload': {label: 'MASD PART 1'},
                ...
                'purchasemode': {label: 'Purchase Mode'},
                'purchaseconstype': {label: 'Purchase Consideration Type'},
                'pricefactor': {label: 'Price Factor'},
                'counterparty': {label: 'counterparty'},
                'counterparty-detail': {label: 'counterparty detail'},
