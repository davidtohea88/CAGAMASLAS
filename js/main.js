    ...
    'ojs/ojjsontreedatasource'
        ...
        function (oj, ko, $, utils) {
            ...
            router.configure({
                ...
                'ratetype': {value:getMasterDataPath('productgroup'),label: 'Rate Type'},
                'purchasemode': {value:getMasterDataPath('purchasemode'),label: 'Purchase Mode'},
                'purchaseconstype': {value:getMasterDataPath('purchaseconstype'),label: 'Purchase Consideration Type'},
