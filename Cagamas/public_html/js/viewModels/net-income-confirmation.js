define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'promise', 'ojs/ojinputtext',
      ...
      function(oj, ko, $)
      {
        function mainModel(){
            ...
            var array = [{Month:'February', Year:'2017', NetIncome:'5,000.00', ActionType:'New', Justification:''},
                        {Month:'January', Year:'2017', NetIncome:'15,000.00', ActionType:'Update', Justification:'Wrong Input'},
                        {Month:'December', Year:'2016', NetIncome:'10,000.00', ActionType:'Update', Justification:'Wrong Input'}];
